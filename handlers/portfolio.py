...
application = webapp.WSGIApplication([
  (r'/portfolio/m(.*)', View),
  (r'/portfolio/i(.*)', ViewMock),
  ('/portfolio/api/getid/', GetID),
  ('/portfolio/api/savemock/', SaveMock),
  ('/portfolio/api/deletemock/', DeleteMock),
  ('/portfolio/api/savemocklist/', SaveMockList),
  ('/portfolio/api/getmocklists/', GetMockLists),
  ('/portfolio/api/deletemocklist/', DeleteMockList),
